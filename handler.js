      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            pp = 'https://imgur.com/a/ZAqFU6j.jpeg' // Assign default image URL
            ppgp = 'https://imgur.com/a/ZAqFU6j.jpeg' // Assign default image URL
          } finally {
            ...
            let welcomeApiUrl = `https://imgur.com/a/ZAqFU6j.jpeg${encodeURIComponent(
              ...
              'https://imgur.com/a/ZAqFU6j.jpeg'
            )}`
              ...
              this.sendMessage(id, {
                ...
                contextInfo: {
                  ...
                  externalAdReply: {
                    ...
                    sourceUrl: 'https://chat.whatsapp.com/BjHW7El8xPyKSTEwcVnPSj',
                    mediaType: 1,
      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            let leaveApiUrl = `https://imgur.com/a/ZAqFU6j.jpeg${encodeURIComponent(
              await this.getName(user)
            )}&guildName=${encodeURIComponent(await this.getName(id))}&guildIcon=${encodeURIComponent(
              ppgp
            )}&memberCount=${encodeURIComponent(
