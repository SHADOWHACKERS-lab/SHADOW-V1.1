  ...
  switch (command) {
   ...
   ┗━━━ʕ•㉨•ʔ━━━┛` // Your bot menu message here
    ...
    case 'ownermenu':
     ...
     ⎪⌲👁️ _${usedPrefix}banuser_
     ⎪⌲👁️ _${usedPrefix}unbanuser_
     ⎪⌲👁️ _${usedPrefix}Broadcast_
     ⎪⌲👁️ _${usedPrefix}Broadcastgc_
     ⎪⌲👁️ _${usedPrefix}join_
     ⎪⌲👁️ _${usedPrefix}setppbot_
     ⎪⌲👁️ _${usedPrefix}setprefix_
     ⎪⌲👁️ _${usedPrefix}resetprefix_
     ⎪⌲👁️ _${usedPrefix}getfile_
     ⎪⌲👁️ _${usedPrefix}getplugin_
     ┗━━━ʕ•㉨•ʔ━━━┛` //
      break
    case 'groupmenu':
      lkr = `❀° ┄──•••───╮
